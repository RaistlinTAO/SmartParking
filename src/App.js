...
class App extends Component {
    ...
    getParkingSpaces = () => {
        ...
        fetch(getParkingSpaces + '?lat=' + this.state.location.lat + '&lng=' + this.state.location.lng + '&offset=2', {
            method: 'POST',
//            headers: {
        ...
        if (this.state.spaces != null) {
            ...
            for (let i = 0; i < this.state.spaces.length; i++) {
                ...
                switch(this.state.spaces[i].spaceType)
                {
                    ...
                    case "0":
                    default:
                        makers.push(<Marker position={position} icon={parkingIconFree}/>);
                        break;
                    case "1":
                        makers.push(<Marker position={position} icon={parkingIconCommercial}/>);
                        break;
                    case "2":
                        makers.push(<Marker position={position} icon={parkingIconPrivate}/>);
                        break;
                }
            ...
            <div className="App">
                <div className="bg-info">
                    ...
                    <Map className="map" center={position} zoom={this.state.zoom}>
                        ...
                        <Marker position={position3} icon={parkingIconFree}>
                    ...
                    <div className="ParkingDesc">
                        <Card>
                            ...
                            <CardBody>
                                ...
                                <CardText>Make some design here Make some design hereMake some design hereMake some
                                    design hereMake some design hereMake some design here </CardText>
